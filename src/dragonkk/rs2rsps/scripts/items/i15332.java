...
public class i15332 extends itemScript {
    ...
    public void option1(Player p, int itemId, int interfaceId, int slot) {
        if (!p.superextremeDonator) {
            p.getFrames().sendChatMessage(0, "You must be a Super Extreme Donator to use this potion.");
            return;
        }
        ...
        p.overload = 11; //2 sec extra for drink
        p.overloadstats = 500; //about 5 min.
